 ...
 * @property Doctrine_Collection $Behaviors
 * 
 ...
 * @method Doctrine_Collection getBehaviors()  Returns the current record's "Behaviors" collection
 ...
 * @method DmWidget            setBehaviors()  Sets the current record's "Behaviors" collection
 * 
 * @package    viveSmart
 * @subpackage model
...
abstract class BaseDmWidget extends myDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasMany('DmBehavior as Behaviors', array(
             'local' => 'id',
             'foreign' => 'dm_widget_id'));
